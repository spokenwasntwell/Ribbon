...
export const BattleAbilities = [
  ...
  },
  {
    ...
    onModifySecondaries (secondaries) {
      ...
      return secondaries.filter(effect =>
        Boolean(effect.self || effect.dustproof)
      );
    },
    id: 'shielddust',
    name: 'Shield Dust',
  ...
  },
  {
    ...
    onBeforeMove (attacker, move) {
      if (
        attacker.template.baseSpecies !== 'Aegislash' ||
  ...
  },
  {
    ...
    onUpdate (pokemon) {
      ...
      const possibleTargets = pokemon.side.foe.active.filter(
